...
export const NAILSERVICES: INailServise[] = [
    ...
    {id: 2,name: 'Маникюр',description: 'Маникюр', price: 100, duration: 1 },
    {id: 3,name: 'Гель лак',description: 'Гель лак', price: 200, duration: 2 },
    {id: 4,name: 'Коррекция',description: 'Коррекция', price: 300, duration: 3 },
    {id: 5,name: 'Наращивание',description: 'Наращивание', price: 350, duration: 3.5 },
    {id: 6,name: 'Выкладной френч',description: 'Выкладной френч', price: 400, duration: 4 },
];
